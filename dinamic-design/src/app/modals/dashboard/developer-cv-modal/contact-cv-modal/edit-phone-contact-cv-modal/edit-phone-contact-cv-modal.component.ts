...
export class EditPhoneContactCvModalComponent implements OnInit {
  ...
  //Sweet Alert Success  
  alertWithSuccess(){
    Swal.fire('Sí!!!', 'El teléfono ha sido actualizado', 'success')
  }

  //Sweet Alert Warning
  alertWithWarning(){
    Swal.fire('Nope!!!', 'El teléfono no ha sido actualizado', 'warning')
  }
