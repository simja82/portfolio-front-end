...
@Component({
  selector: 'app-create-audiovisual-quote-modal',
  templateUrl: './create-audiovisual-quote-modal.component.html'
})
export class CreateAudiovisualQuoteModalComponent implements OnInit {
  ...
  //Sweet Alert Success  
  alertWithSuccess(){
    Swal.fire('Sí!!!', 'La frase ha sido creada', 'success')
  }

  //Sweet Alert Warning
  alertWithWarning(){
    Swal.fire('Nope!!!', 'La frase no ha sido creada', 'warning')
  }
