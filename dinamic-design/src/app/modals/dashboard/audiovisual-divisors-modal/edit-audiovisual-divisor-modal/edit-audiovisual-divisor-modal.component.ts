...
@Component({
  selector: 'app-edit-audiovisual-divisor-modal',
  templateUrl: './edit-audiovisual-divisor-modal.component.html'
})
export class EditAudiovisualDivisorModalComponent implements OnInit {
  ...
  //Sweet Alert Warning
  alertWithWarning(){
    Swal.fire('Nope!!!', 'El divisor no ha sido actualizado', 'warning')
  }
