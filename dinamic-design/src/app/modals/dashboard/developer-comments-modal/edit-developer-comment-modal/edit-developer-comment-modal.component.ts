...
@Component({
  selector: 'app-edit-developer-comment-modal',
  templateUrl: './edit-developer-comment-modal.component.html'
})
export class EditDeveloperCommentModalComponent implements OnInit {
  ...
  //Sweet Alert Success  
  alertWithSuccess(){
    Swal.fire('Sí!!!', 'El comentario ha sido actualizado', 'success')
  }

  //Sweet Alert Warning
  alertWithWarning(){
    Swal.fire('Nope!!!', 'El comentario no ha sido actualizado', 'warning')
  }
