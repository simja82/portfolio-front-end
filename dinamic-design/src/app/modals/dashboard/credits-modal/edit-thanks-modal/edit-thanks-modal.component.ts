...
@Component({
  selector: 'app-edit-thanks-modal',
  templateUrl: './edit-thanks-modal.component.html'
})
export class EditThanksModalComponent implements OnInit {
  ...
  //Sweet Alert Success  
  alertWithSuccess(){
    Swal.fire('Sí!!!', 'El agradecimiento ha sido actualizado', 'success')
  }

  //Sweet Alert Warning
  alertWithWarning(){
    Swal.fire('Nope!!!', 'El agradecimiento no ha sido actualizado', 'warning')
  }
