...
@Component({
  selector: 'app-create-audiovisual-series-modal',
  templateUrl: './create-audiovisual-series-modal.component.html'
})
export class CreateAudiovisualSeriesModalComponent implements OnInit {
  ...
  //Sweet Alert Success  
  alertWithSuccess(){
    Swal.fire('Sí!!!', 'La Serie ha sido creada', 'success')
  }

  //Sweet Alert Warning
  alertWithWarning(){
    Swal.fire('Nope!!!', 'La Serie no ha sido creada', 'warning')
  }
