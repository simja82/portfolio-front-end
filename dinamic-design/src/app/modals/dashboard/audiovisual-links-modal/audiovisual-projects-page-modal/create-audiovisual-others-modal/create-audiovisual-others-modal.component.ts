...
@Component({
  selector: 'app-create-audiovisual-others-modal',
  templateUrl: './create-audiovisual-others-modal.component.html'
})
export class CreateAudiovisualOthersModalComponent implements OnInit {
  ...
  //Sweet Alert Success  
  alertWithSuccess(){
    Swal.fire('Sí!!!', 'El Contenido ha sido creado', 'success')
  }

  //Sweet Alert Warning
  alertWithWarning(){
    Swal.fire('Nope!!!', 'El Contenido no ha sido creado', 'warning')
  }
