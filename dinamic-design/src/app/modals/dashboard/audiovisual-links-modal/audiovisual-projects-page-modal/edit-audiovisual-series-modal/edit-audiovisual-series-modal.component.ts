...
@Component({
  selector: 'app-edit-audiovisual-series-modal',
  templateUrl: './edit-audiovisual-series-modal.component.html'
})
export class EditAudiovisualSeriesModalComponent implements OnInit {
  ...
  //Sweet Alert Success  
  alertWithSuccess(){
    Swal.fire('Sí!!!', 'La Serie ha sido editada', 'success')
  }

  //Sweet Alert Warning
  alertWithWarning(){
    Swal.fire('Nope!!!', 'La Serie no ha sido editada', 'warning')
  }
