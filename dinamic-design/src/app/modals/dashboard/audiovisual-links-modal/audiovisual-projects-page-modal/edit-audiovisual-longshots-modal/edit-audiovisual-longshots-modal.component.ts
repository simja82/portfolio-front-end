...
@Component({
  selector: 'app-edit-audiovisual-longshots-modal',
  templateUrl: './edit-audiovisual-longshots-modal.component.html'
})
export class EditAudiovisualLongshotsModalComponent implements OnInit {
  ...
  //Sweet Alert Success  
  alertWithSuccess(){
    Swal.fire('Sí!!!', 'El Longshot ha sido editado', 'success')
  }

  //Sweet Alert Warning
  alertWithWarning(){
    Swal.fire('Nope!!!', 'El Longshot no ha sido editado', 'warning')
  }
