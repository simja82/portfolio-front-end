...
@Component({
  selector: 'app-edit-audiovisual-others-modal',
  templateUrl: './edit-audiovisual-others-modal.component.html'
})
export class EditAudiovisualOthersModalComponent implements OnInit {
  ...
  //Sweet Alert Success  
  alertWithSuccess(){
    Swal.fire('Sí!!!', 'El Contenido ha sido editado', 'success')
  }

  //Sweet Alert Warning
  alertWithWarning(){
    Swal.fire('Nope!!!', 'El Contenido no ha sido editado', 'warning')
  }
