...
@Component({
  selector: 'app-create-audiovisual-sample-modal',
  templateUrl: './create-audiovisual-sample-modal.component.html'
})
export class CreateAudiovisualSampleModalComponent implements OnInit {
  ...
  //Sweet Alert Success  
  alertWithSuccess(){
    Swal.fire('Sí!!!', 'La Muestra ha sido creada', 'success')
  }

  //Sweet Alert Warning
  alertWithWarning(){
    Swal.fire('Nope!!!', 'La Muestra no ha sido creada', 'warning')
  }
